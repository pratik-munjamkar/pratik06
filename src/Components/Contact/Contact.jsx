...
export default function Contact() {
  const API_URL = "https://portfolio-06.herokuapp.com"; //export to another file and use across all files
      ...
      <div className="container">
        <div className="left">
          ...
          <div className="left-line">
            ...
            <div className="left-details">
              <h4>E-mail</h4>
              <p>pratikmunjamkar23@gmail.com</p>
            </div>
          </div>
          ...
          <div className="icon-click">
            <a
              href="https://www.linkedin.com/in/pratik-munjamkar0626/"
              target="_blank"
              rel="noreferrer"
            >
